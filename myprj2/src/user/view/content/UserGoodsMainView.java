...
///////////////////////////////////////////
		...
		ImageIcon mainLogoImg = new ImageIcon(ClientLoginView.USER_FILE_PATH+"/prj2_logo_back_white_main.PNG");
		JLabel jlMainLogo = new JLabel(mainLogoImg);
		
		jlMainLogo.setBounds(20, 10, 250, 60);
		...
		//////////////////////////////////////////////////////////////////////
		ImageIcon logoImg =new ImageIcon(ClientLoginView.USER_FILE_PATH+"/prj2_logo_back_gray_footer.PNG");
		JLabel jlname = new JLabel(logoImg);
		Font f = new Font("맑은 고딕", Font.BOLD, 40);
		Font f1 = new Font("맑은 고딕", Font.PLAIN, 20);
		jlname.setFont(f);
		jlname.setForeground(Color.white);
		jlname.setBounds(20, 40, 250, 68);
